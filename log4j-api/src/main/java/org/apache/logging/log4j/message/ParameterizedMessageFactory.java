...
public class ParameterizedMessageFactory extends AbstractMessageFactory {
    ...
    public Message newMessage(final String messagePattern, final Object[] arguments, final Throwable throwable) {
        return new ParameterizedMessage(messagePattern, arguments, throwable);
    }
}
